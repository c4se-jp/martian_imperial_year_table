...
export function computeJulianComponents(grdt: GregorianDateTime): JulianComponents {
...
export function computeJulianValue(grdt: GregorianDateTime): number {
