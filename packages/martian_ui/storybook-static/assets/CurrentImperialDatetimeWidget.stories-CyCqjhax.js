import { j as r, I as k, B as q, T as x, m as c } from "./widgetTypes-mMQVU1UR.js";
import { r as i } from "./iframe-CFA6LYn8.js";
import "./preload-helper-PPVm8Dsz.js";
function p({ currentTimezone: n, onCurrentTimezoneChange: e, onFetch: t, running: o }) {
...
function y({ callTool: n, initialResult: e, subscribeToolResult: t }) {
  const [o, l] = i.useState("+00:00"),
    [_, s] = i.useState(e?.structuredContent?.mode === "get_current_imperial" ? e : void 0),
    [v, g] = i.useState(!1);
  (i.useEffect(() => {
    e?.structuredContent?.mode === "get_current_imperial" && s(e);
  }, [e]),
    i.useEffect(() => {
      t !== void 0 &&
        t((a) => {
          a.structuredContent?.mode === "get_current_imperial" && s(a);
        });
    }, [t]));
  async function w(a, d) {
    g(!0);
    try {
      const f = await (n ?? T)(a, d);
      s(f);
    } catch (u) {
      s({
        structuredContent: { mode: c(a), request: d, error: u instanceof Error ? u.message : String(u) },
        isError: !0,
      });
    } finally {
      g(!1);
  ...
  return r.jsxs("main", {
    ...
    children: [
      r.jsx("h1", { className: "heading-md", children: "現在の帝國火星曆日時" }),
      r.jsx("p", {
        className: "text-sm text-secondary",
        children: "指定したタイムゾーンで現在の帝國火星曆日時を取得します。",
      }),
      r.jsx(p, {
        currentTimezone: o,
        onCurrentTimezoneChange: l,
        onFetch: () => w("get_current_imperial_datetime", { timezone: o }),
        running: v,
      }),
      r.jsx("section", {
        className: "mt-4",
        children: r.jsx(x, { emptyMessage: "現在の帝國火星曆日時がここに表示されます。", result: _ }),
      }),
    ],
  });
}
y.__docgenInfo = {
  description: "",
  methods: [],
  displayName: "CurrentImperialDatetimeWidget",
  props: {
    callTool: {
      required: !1,
      tsType: {
...
const h = { title: "Widget/CurrentImperialDatetimeWidget", component: y };
function C(n, e) {
  return {
    structuredContent: {
      mode: n === "get_current_imperial_datetime" ? "get_current_imperial" : "convert_gregorian_to_imperial",
      request: e,
      response: {
...
const m = { args: { callTool: async (n, e) => (await new Promise((t) => setTimeout(t, 120)), C(n, e)) } };
m.parameters = {
  ...m.parameters,
  docs: {
    ...m.parameters?.docs,
...
const E = ["Default"];
export { m as Default, E as __namedExportsOrder, h as default };
