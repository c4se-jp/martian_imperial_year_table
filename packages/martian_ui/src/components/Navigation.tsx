      ...
      <div className="container">
        <div className="navbar-brand">
          <Link className="navbar-item" to="/">
            <img
              src={`${imageBaseUrl}martian_empire.png`}
              alt="帝國火星曆"
              style={{ width: "38px", marginRight: "0.75rem" }}
            />
            <div>
        ...
        <div className="navbar-menu">
          <div className="navbar-start">
            ...
            <NavLink className={({ isActive }) => `navbar-item ${isActive ? "is-active" : ""}`} to="/docs/api">
              API
            </NavLink>
            <NavLink className={({ isActive }) => `navbar-item ${isActive ? "is-active" : ""}`} to="/docs/mcp">
              MCP
            </NavLink>
          </div>
          <div className="navbar-end">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <img src={`${imageBaseUrl}GitHub-Mark-120px-plus.png`} alt="GitHub" style={{ width: "28px" }} />
            </a>
          </div>
        </div>
      </div>
