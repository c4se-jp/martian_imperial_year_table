  ...
  "endpoints": [
    {
      ...
      "description": "帝國火星曆の文字列表記 (1428-19-18T01:29:08+00:00 のやうな形式) とグレゴリオ曆でのタイムゾーンを受け取り、對應するグレゴリオ曆日時 (ISO 8601 文字列) を返す。\n",
      "tags": [
        "imperial-datetime"
      ],
      "parameters": [],
      ...
      "parameters": [
        {
          ...
          "in": "query",
          "required": false,
          "description": "帝國火星曆のタイムゾーン。省略時は +00:00 (基準時)。 形式は +09:00 のやうな ±HH:MM。timezone=%2B09:00 等の樣にURLエンコードする事。\n",
          "schema": {
            "type": "string",
            "pattern": "^([+-])(\\d{2}):(\\d{2})$",
            "defaultValue": "+00:00",
    ...
    },
    {
      ...
      "description": "グレゴリオ曆での日時 (ISO 8601 文字列) と帝國火星曆でのタイムゾーンを受け取り、對應する帝國火星曆日時を返す。\n",
      "tags": [
        "imperial-datetime"
      ],
      "parameters": [],
