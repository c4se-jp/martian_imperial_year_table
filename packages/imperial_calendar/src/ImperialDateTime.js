...
function parseImperialTimezone(timezone) {
...
export class ImperialDateTime {
    ...
    valueOf() {
        ...
        return (naive.year * 1_000_000_000_000 +
    ...
    static fromStandardNaive(imdt, timezone) {
    ...
    toStandardNaive() {
        ...
        const imsn = imdtToImsn(new ImperialDateTime(this.year, this.month, this.day, this.hour, this.minute, this.second, null));
        let day = imsn.day;
