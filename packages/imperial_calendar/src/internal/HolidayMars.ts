...
function cloneHolidays(source: HolidaysRecord): HolidaysRecord {
  const clone: HolidaysRecord = {};
...
const DEFAULT_HOLIDAYS: HolidaysRecord = {
  1425: {
    1: {
      1: new Internal("四方節"),
      2: new Internal("振替休日"),
    ...
    17: { 19: new Internal("天長節") },
    18: { 2: new Internal("地久節") },
    20: { 16: new Internal("神嘗祭") },
...
class Holidays {
  static holidays: HolidaysRecord = cloneHolidays(DEFAULT_HOLIDAYS);
