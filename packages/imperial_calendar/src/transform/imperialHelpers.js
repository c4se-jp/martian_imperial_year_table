...
export function toImperialSolNumber(imdt) {
...
export function deriveImperialDateTimeFields(imsn) {
    ...
    while (yearsInMillennium + 1 < imperialYearToImsnTable.length &&
...
export function fromImperialDateTime(imdt) {
